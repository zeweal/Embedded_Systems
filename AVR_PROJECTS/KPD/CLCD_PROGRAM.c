...
/***************************************************************** 8BITS ***********************************************************************************/
	...
	DIO_SET_PORT_DIRECTION(CLCD_DATA_PORT,DIO_OUTPUT);
    DIO_SET_PIN_DIRECTION(CLCD_CONTROL_PORT,CLCD_RS,DIO_PORT_OUTPUT);
	...
	CLCD_SEND_COMMAND( 0x28 ); // 4Bit Mode ==> 0x28
	_delay_ms(1); // wait more than 39 Ms
